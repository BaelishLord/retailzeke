            ...
            <div class = "pull-right">
                <div class = "btn-group">
                    <a href="/{{Request::path()}}/create">
                        <button type="button" class="btn btn-sharekhan" data-original-title="Add Call Complete" data-original-title="Add Call Complete" data-toggle="tooltip" data-target="" title="Add Call Complete" data-original-title="Add {{ucwords(str_replace('-', ' ', Request::segment(2)))}}">
